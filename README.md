...
| **Acento do produto** | `--accent` / `--accent-dark` / `--accent-soft` (`data-accent="ticket|dental|store|invoice|nail|cut|lash|ink|massage|brow|piercing"`) | filete do header do produto, título da página, links, chips/abas selecionados, ícones de destaque, foco |
