...
| **Acento do produto** | `--accent` / `--accent-dark` / `--accent-soft` (`data-accent="ticket|schedule|vendas|budget|nail|barbearia"`) | filete do header do produto, título da página, links, chips/abas selecionados, ícones de destaque, foco |
